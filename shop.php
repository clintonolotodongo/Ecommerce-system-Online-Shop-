                    ...
                    <div class="shop__sidebar__accordion">
                        <form method="POST" action="shop.php">
                            <div class="accordion" id="accordionExample">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Alfabet" name="category" id="category_one" <?php if (isset($category) && $category == 'Computing') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Angka" name="category" id="category_two" <?php if (isset($category) && $category == 'Phones') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                            Phone & Tablets
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Kalender" name="category" id="category_three" <?php if (isset($category) && $category == 'TV') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                                TV & Audio
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Peta" name="category" id="category_four" <?php if (isset($category) && $category == 'Appliances') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                            Appliances
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Hewan" name="category" id="category_five" <?php if (isset($category) && $category == 'Fashion') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                            Fashion
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Tabel Periodik" name="category" id="category_five" <?php if (isset($category) && $category == 'Gaming') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                            Gaming
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Buah dan Sayur" name="category" id="category_five" <?php if (isset($category) && $category == 'Health & Beauty') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                            Health & Beauty
                                ...
                                <div class="card">
                                    <div class="card-heading">
                                        <a data-toggle="collapse" data-target="#collapseTwo"> Type <i class="fas fa-chevron-down"></i></a>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Art Paper" name="brand" id="brand_one" <?php if (isset($brand) && $brand == 'Laptops') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Laminasi Glossy" name="brand" id="brand_two" <?php if (isset($brand) && $brand == 'Smart Phones') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Smart Phones
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="NCR" name="brand" id="brand_three" <?php if (isset($brand) && $brand == 'TV') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            TV
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Concorde" name="brand" id="brand_four" <?php if (isset($brand) && $brand == 'Appliances') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Appliances
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Art Carton" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Gaming') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Gaming
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Ivory" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Health') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Health
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Matt Paper" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Shoes') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Shoes
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Linen Jepang" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Shirts') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                            Shirts
